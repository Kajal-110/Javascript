...
var sNo = 6;
 ...
 addNewRow=() =>{
  ...
  call1.innerHTML = `${sNo++} `
  call2.innerHTML = '<input type="text" placeholder="Name" class=" name" onclick="validate();"   title=" you can enter only alphabates here" required / > '
...
//   if(!regName.test(name).value.length>15){
